...
\begin{frame}[c]
\frametitle{Geant4 simulation: nuclear interaction}
% Initial validation 

  \begin{columns}
  \begin{column}{0.49\textwidth}
  \includegraphics[width=\textwidth,height=3.5cm]{images/gs20_attenuation_simulated.png}
  \includegraphics[width=\textwidth,height=3.5cm]{images/energy_deposition.png}
  \end{column}
  \begin{column}{0.49\textwidth}
  \includegraphics[width=\textwidth,height=3.5cm]{images/xy_spatial_distribution.png}
  \includegraphics[width=\textwidth,height=3.5cm]{images/z_spatial_distribution.png}
  \end{column}
  \end{columns}
\end{frame}

\begin{frame}
\frametitle{Geant4 simulation: optical properties}
  \begin{columns}
  \begin{column}{0.49\textwidth}
  \includegraphics[width=\textwidth,height=3.5cm]{images/gs20_attenuation_simulated.png}
  \includegraphics[width=\textwidth,height=3.5cm]{images/energy_deposition.png}
